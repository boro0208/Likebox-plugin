...
class Likebox_Widget  extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'A simple likebox widget', 'text_domain' ), ) // Args
		);
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['show_header'] = ( ! empty( $new_instance['show_header'] ) ) ? sanitize_text_field( $new_instance['show_header'] ) : '';
		$instance['show_posts'] = ( ! empty( $new_instance['show_posts'] ) ) ? sanitize_text_field( $new_instance['show_posts'] ) : '';
		$instance['show_border'] = ( ! empty( $new_instance['show_border'] ) ) ? sanitize_text_field( $new_instance['show_border'] ) : '';

		return $instance;
    }
    //Get and display Likeboc
    ...
    public function getForm($instance){
        $title = ! empty( $instance['title'] ) ? $instance['title']  : esc_html__( 'Like Us On Facebook', 'text_domain' );
        $page_url = ! empty( $instance['page_url'] ) ? $instance['page_url'] : 'https://www.facebook.com/FacebookDevelopers';
        ...
        $show_faces = ! empty( $instance['show_faces'] ) ? $instance['show_faces'] : 'true';
        $show_header = ! empty( $instance['show_header'] ) ? $instance['show_header'] : 'true';
        $show_posts = ! empty( $instance['show_posts'] ) ? $instance['show_posts'] : 'false';
        $show_border = ! empty( $instance['show_border'] ) ? $instance['show_border'] : 'true';
